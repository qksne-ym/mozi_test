...
class Features(object):
    def __init__(self, env, scenario, sideName):
        ...
        self.stat_type = {
            ...
            'self_consumed_air2airmissile': self.second_category['consumed_weapon_type'] + self.weapons_type[
                'air2air_missile'],
            'self_consumed_antishipmissile': self.second_category['consumed_weapon_type'] + self.weapons_type[
                'antiship_missile'],
            ...
            'self_surplus_air2airmissile': self.second_category['surplus_weapon_type'] + self.weapons_type[
                'air2air_missile'],
            'self_surplus_antishipmissile': self.second_category['surplus_weapon_type'] + self.weapons_type[
                'antiship_missile'],
    ...
    def _features(self):
        ...
        feat_self_consumed_weapon = self._generate_features('stat_self_consumed_weapon_type',
                                                            ...
                                                            'self_consumed_antishipmissile',
                                                            'self_consumed_airdefensemissile')
        # 任务中所有单元剩余武器类型stat_self_surplus_weapon_type
        feat_self_surplus_weapon = self._generate_features('stat_self_surplus_weapon_type',
                                                           ...
                                                           'self_surplus_antishipmissile',
                                                           'self_surplus_airdefensemissile')
        # 探测到的敌方单元类型stat_hostile_unit_type
    ...
    def _generate_features(self, feat_type, *args):
        ...
        if feat_type == 'stat_self_idle_unit_type':
            ...
            for key in ['self_saw_zone_asuw', 'self_saw_zone_asup', 'self_saw_zone_destroyer',
                        'self_saw_zone_aircarrier']:
                value = [int(i) for i in list(self.stat_type[key])]
                unit_type = key[key.rfind('_') + 1:]
